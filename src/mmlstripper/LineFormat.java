...
/**
 * Format that applies to an entire line
 * @author desmond
 */
public class LineFormat implements Comparable 
{
    String endTag;
    String startTag;
    String prop;
    LineFormat( String startTag, String endTag, String prop )
    {
        this.endTag = endTag;
    ...
    {
        return this.startTag.compareTo(((LineFormat)other).startTag);
    }
}
